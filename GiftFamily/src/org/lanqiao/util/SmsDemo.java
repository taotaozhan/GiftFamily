...
public class SmsDemo {
    ...
    static final String accessKeyId = "LTAIwN06KDZlKce2";
    static final String accessKeySecret = "EB1NBWC6wETPSFlp5tYbr4cKH3HfPt";
    ...
    public static SendSmsResponse sendSms(String phone,String message) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("淘淘网");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_136391329");
   ...
   /* public static void main(String[] args) throws ClientException, InterruptedException {
        ...
        //发短信
    	String phone = "15529238019";
        SendSmsResponse response = sendSms(phone,"1234");
