...
<div class="width1200 center_yh" style="height:300px;margin-top:40px;">
	<div class="tone">
        ...
        <a href="#"><img src="images/sp3.jpg"></a>
        <a href="#"><img src="images/sp4.jpg"></a>
        <a href="#"><img src="images/sp5.jpg"></a>
    </div>
</div>
<!--工艺礼品-->
<div class="width1200 center_yh hidden_yh">
	<div class="width100" style="height:45px;line-height:45px;border-bottom:2px solid #dd4545;margin-top:20px;">
    	<font class="left_yh font20">工艺礼品</font>
        <a href="#" class="right_yh c_33 font16">更多»</a>
    </div>
    <div class="width100 hidden_yh" style="height:388px;">
    	<a href="#" style="width:227px;height:388px;float:left;"><img src="images/lb1.jpg"></a>
        <div class="normalPic">
        	<a href="#">
            	<h3 class="yihang c_33 font14 font100" style="padding-left:10px;padding-right:10px;margin-top:10px;">客厅摆件 家居饰品中式办公室</h3>
                <p class="red font14" style="padding-left:10px;">￥299.9</p>
                <img src="images/p.jpg" width="105" height="118" style="margin:0 auto">
            </a>
            <a href="#">
            	<h3 class="yihang c_33 font14 font100" style="padding-left:10px;padding-right:10px;margin-top:10px;">客厅摆件 家居饰品中式办公室</h3>
                <p class="red font14" style="padding-left:10px;">￥299.9</p>
...
<div class="width1200 center_yh hidden_yh">
	<div class="width100" style="height:45px;line-height:45px;border-bottom:2px solid #dd4545;margin-top:20px;">
    	<font class="left_yh font20">品牌礼品</font>
        <a href="#" class="right_yh c_33 font16">更多»</a>
    </div>
    <div class="width100 hidden_yh" style="height:388px;">
    	<a href="#" style="width:227px;height:388px;float:left;"><img src="images/lb1.jpg"></a>
...
<div class="width1200 center_yh hidden_yh">
	<div class="width100" style="height:45px;line-height:45px;border-bottom:2px solid #dd4545;margin-top:20px;">
    	<font class="left_yh font20">商务礼品</font>
        <a href="#" class="right_yh c_33 font16">更多»</a>
    </div>
    <div class="width100 hidden_yh" style="height:388px;">
    	<a href="#" style="width:227px;height:388px;float:left;"><img src="images/lb1.jpg"></a>
...
<div class="width1200 center_yh hidden_yh">
	<div class="width100" style="height:45px;line-height:45px;border-bottom:2px solid #dd4545;margin-top:20px;">
    	<font class="left_yh font20">食品礼盒</font>
        <a href="#" class="right_yh c_33 font16">更多»</a>
    </div>
    <div class="width100 hidden_yh" style="height:388px;">
    	<a href="#" style="width:227px;height:388px;float:left;"><img src="images/lb1.jpg"></a>
